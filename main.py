...
TIMEFRAME = "15"  # 15-хвилинний таймфрейм
LIMIT = 100
LEVERAGE = 5
BALANCE = 15
POSITION_SIZE = BALANCE * 0.1 * LEVERAGE  # 10% від балансу з плечем 5x
...
def get_klines(symbol):
    ...
    try:
        ...
        data = response.json()
        return [float(kline[4]) for kline in data["result"]["list"]]  # Закриття свічок
...
if __name__ == "__main__":
    while True:
        check_signals()
        time.sleep(60 * 15)  # перевірка кожні 15 хвилин
